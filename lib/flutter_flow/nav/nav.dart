...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'MultimeterCopy',
          path: '/multimeterCopy',
          builder: (context, params) => MultimeterCopyWidget(
            deviceName: params.getParam(
              'deviceName',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'MultimeterCopyCopy',
          path: '/multimeterCopyCopy',
          builder: (context, params) => MultimeterCopyCopyWidget(
            deviceName: params.getParam(
              'deviceName',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'MultimeterCopyCopyCopy',
          path: '/multimeterCopyCopyCopy',
          builder: (context, params) => MultimeterCopyCopyCopyWidget(
            deviceName: params.getParam(
              'deviceName',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'WaveGen',
          path: '/waveGen',
          builder: (context, params) => WaveGenWidget(
            deviceName: params.getParam(
              'deviceName',
              ParamType.String,
            ),
